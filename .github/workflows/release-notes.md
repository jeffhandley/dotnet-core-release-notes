...
# Write Release Notes - Bisect Checkpoint 3

Checkpoint 1 and the first-half restoration both passed. This checkpoint
restores the remaining workflow behavior so the run exercises the full release
notes flow end-to-end.
