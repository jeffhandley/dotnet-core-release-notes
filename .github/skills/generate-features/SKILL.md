...
First, get the correct package versions from `build-metadata.json` (generated by `release-notes generate build-metadata`). Then query the NuGet packages directly:
